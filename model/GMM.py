...
## Remove low-variance features (if needed)
...
gmm = GaussianMixture(n_components=2, random_state=3)  # Clustering into 2 clusters: ransomware and benign
gmm.fit(X_var)

# Predict cluster labels
cluster_labels = gmm.predict(X_var)
